...
def main():
    ...
    date_since = "2016-08-26"
    date_until = "2016-09-02"
    ...
    tweetCriteria = got.manager.TweetCriteria().setQuerySearch('Xbox').setSince(date_since).setUntil(date_until).setMaxTweets(max_tweets).skip_tweets(skip_tweets)
